        ...
        <v-layout column align-center>
          <v-flex xs6 sm8 md7>
            <v-alert
              ...
              :value="true"
              type="error"
            >Please verify Customer information.</v-alert>
          </v-flex>
        </v-layout>
          ...
          <v-card-text>
            <v-form ref="form" lazy-validation>
              <v-container>
                ...
                <v-text-field v-model="customer.organization" label="Organization" required />
                <v-text-field v-model="customer.role" label="Role" required />
                <v-text-field v-model="customer.email" label="Email" required />
                <v-text-field v-model="customer.bldgroom" label="Bldg-Room" required />
                <v-text-field v-model="customer.address" label="Address" required />
                <v-text-field v-model="customer.account_number" label="Account" required />
                <v-text-field v-model="customer.city" label="City" required />
                <v-text-field v-model="customer.state" label="State" required />
                <v-text-field v-model="customer.zipcode" label="Zip Code" required />
                <v-text-field v-model="customer.phone_number" label="Phone" required />
              </v-container>
