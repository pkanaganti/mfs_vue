  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        {text: 'Organization', sortable: false, align: 'left',},
        {text: 'Role', sortable: false, align: 'left',},
        {text: 'Email', sortable: false, align: 'left',},
        {text: 'Bldg-Room', sortable: false, align: 'left',},
        {text: 'Address', sortable: false, align: 'left',},
        {text: 'Account', sortable: false, align: 'left',},
